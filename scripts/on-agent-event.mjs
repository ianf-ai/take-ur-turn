 ...
 *
 * Usage: on-agent-event.mjs <event> <agent> <pane>   event ∈ working | blocked | done
 *
 ...
 * argv contract violations (wrong arity, event outside working|blocked|done)
 * exit 1.
 *
...
const USAGE = "usage: on-agent-event.mjs <working|blocked|done> <agent> <pane>";
const EVENTS = new Set(["working", "blocked", "done"]);
